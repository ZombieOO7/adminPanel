...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <a href="{{route('admin.dashboard')}}">
            <img alt="Logo" src="{{@$setting->attachment->logo_path ?? asset('backend/media/logos/logo-1.svg')}}" class="h-25px logo" />
        </a>
    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="menu-link @if($routeName == 'admin.dashboard') active @endif" href="{{route('admin.dashboard')}}">
                ...
                <div class="menu-item">
                    <a class="menu-link @if($routeName == 'admin.user.index' || $routeName == 'admin.user.create' || $routeName == 'admin.user.edit') active @endif" href="{{route('admin.user.index')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <rect x="2" y="2" width="9" height="9" rx="2" fill="black" />
                        ...
                        <span class="menu-title">{{__('label.user_mng')}}</span>
                    </a>
                </div>
                {{-- Settings Route --}}
                <div class="menu-item">
                    <a class="menu-link @if($routeName == 'admin.setting') active @endif" href="{{route('admin.setting')}}">
                        <span class="menu-icon">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">{{__('label.setting')}}</span>
                    </a>
                </div>
                {{-- Profile Route --}}
                <div class="menu-item">
                    <a class="menu-link @if($routeName == 'admin.profile') active @endif" href="{{route('admin.profile')}}">
                        <span class="menu-icon">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title">{{__('label.profile')}}</span>
                    </a>
                </div>
                {{-- <div class="menu-item">
